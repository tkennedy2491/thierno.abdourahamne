...
export function Skills() {
  ...
  const skillsData = [
    ...
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" className="w-16 h-16">
          <g id="SVGRepo_bgCarrier_prisma_skills" strokeWidth="0"></g>
          <g id="SVGRepo_tracerCarrier_prisma_skills" strokeLinecap="round" strokeLinejoin="round"></g>
          <g id="SVGRepo_iconCarrier_prisma_skills">
            <title>file_type_light_prisma</title>
            <path d="M25.21,24.21,12.739,27.928a.525.525,0,0,1-.667-.606L16.528,5.811a.43.43,0,0,1,.809-.094l8.249,17.661A.6.6,0,0,1,25.21,24.21Zm2.139-.878L17.8,2.883h0A1.531,1.531,0,0,0,16.491,2a1.513,1.513,0,0,0-1.4.729L4.736,19.648a1.592,1.592,0,0,0,.018,1.7l5.064,7.909a1.628,1.628,0,0,0,1.83.678l14.7-4.383a1.6,1.6,0,0,0,1-2.218Z" style={{ fill: '#0c344b', fillRule: 'evenodd' }}></path>
          </g>
        </svg>
      ),
      borderColor: 'border-b-[#0c344b]'
    },
    {
      title: 'TailwindCSS',
    ...
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-16 h-16">
          <g id="SVGRepo_bgCarrier_linux_skills" strokeWidth="0"></g>
          <g id="SVGRepo_tracerCarrier_linux_skills" strokeLinecap="round" strokeLinejoin="round"></g>
          <g id="SVGRepo_iconCarrier_linux_skills">
            <path d="M30 16C30 23.728 23.735 30 16 30C8.265 30 2 23.728 2 16C2 8.265 8.265 2 16 2C23.735 2 30 8.265 30 16Z" fill="white"></path>
            <path d="M11.3063 21.91C11.181 21.7232 11.0714 21.4713 10.9824 21.1699C9.37571 19.358 10.6169 16.6916 11.8446 14.881C11.9623 14.6874 12.0905 14.5004 12.2299 14.3215C13.1666 13.1577 13.4089 12.3478 13.481 11.2521C13.4896 11.0481 13.4727 10.7781 13.4533 10.4678C13.3542 8.8837 13.1895 6.25174 16.0159 6.0184C19.5489 5.72669 19.2611 8.97105 19.235 10.8732C19.2339 10.9519 19.2328 11.0285 19.2321 11.1024C19.2225 12.249 19.8209 13.0341 20.4455 13.8535C20.6736 14.1528 20.9052 14.4566 21.112 14.7843C21.1181 14.794 21.1242 14.8038 21.1303 14.8135C22.2218 16.3877 23.2994 18.737 21.7995 20.9653C21.5887 21.7259 21.2695 22.424 20.8434 22.9921C19.3136 25.0052 17.9539 24.8008 16.892 24.6412C16.5717 24.5931 16.2785 24.549 16.0159 24.5711C15.5797 24.5977 15.2301 24.6682 14.9281 24.7292C13.7608 24.9648 13.3046 25.0569 11.3063 21.91Z" fill="#000000"></path>
            <path d="M18.0139 7.79452C17.9811 8.72691 16.9921 9.53681 15.8065 9.61167C14.6209 9.68654 13.6907 8.97873 13.7235 8.04633C13.7562 7.11393 14.7453 6.30404 15.9309 6.22917C17.1165 6.16112 18.0466 6.86212 18.0139 7.79452Z" fill="url(#paint0_linear_87_7435_skills)"></path>
    ...
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="none" className="w-16 h-16">
          <g id="SVGRepo_bgCarrier_aws_skills" strokeWidth="0"></g>
          <g id="SVGRepo_tracerCarrier_aws_skills" strokeLinecap="round" strokeLinejoin="round"></g>
          <g id="SVGRepo_iconCarrier_aws_skills">
    ...
    },
    {
      ...
      icon: (
        <svg fill="currentColor" viewBox="0 0 24 24" role="img" xmlns="http://www.w3.org/2000/svg" className="w-16 h-16 text-white">
          <g id="SVGRepo_bgCarrier_socket_skills" strokeWidth="0"></g>
          <g id="SVGRepo_tracerCarrier_socket_skills" strokeLinecap="round" strokeLinejoin="round"></g>
          <g id="SVGRepo_iconCarrier_socket_skills">
