...
const orbitItems = [
  ...
  { icon: <TechIcons.Express />, angle: 157.5 },
  { icon: <TechIcons.TS />, angle: 202.5 },
  { icon: <TechIcons.Next />, angle: 247.5 },
  { icon: <TechIcons.Laravel />, angle: 292.5 },
  { icon: <TechIcons.Tailwind />, angle: 337.5 },
];
