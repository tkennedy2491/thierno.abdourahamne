...
const TechIcons = {
  ...
  NodeJS: () => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" className="w-9 h-9">
      ...
      <path fill="#83CD29" d="M88.984 67.974c.061-.034.135-.034.195 0l1.615.933c.06.035.097.1.097.169v1.865c0 .07-.037.134-.097.169l-1.615.932c-.06.035-.135.035-.195 0l-1.614-.932c-.061-.035-.098-.099-.098-.169v-1.865c0-.069.037-.134.098-.169l1.614-.933"/>
  ...
  TS: () => (
    <div className="bg-[#3178c6] text-white font-bold rounded-sm w-9 h-9 flex items-center justify-center text-xs shadow-xl border border-white/10">TS</div>
  ),
  Kubernetes: () => (
