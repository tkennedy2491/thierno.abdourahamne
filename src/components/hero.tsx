...
const TechIcons = {
  ...
  SocketIO: () => (
    <div className="bg-white text-black font-bold rounded-full w-10 h-10 flex items-center justify-center text-xs shadow-xl">S.IO</div>
  ),
  Redis: () => (
  ...
  TS: () => (
    <div className="bg-[#3178c6] text-white font-bold rounded-sm w-10 h-10 flex items-center justify-center text-sm shadow-xl">TS</div>
  ),
  Kubernetes: () => (
  ...
  DotNet: () => (
    <div className="bg-[#512bd4] text-white font-bold rounded-lg w-10 h-10 flex items-center justify-center text-xs shadow-xl">.NET</div>
  ),
  Angular: () => (
  ...
  Bootstrap: () => (
    <div className="bg-[#7952b3] text-white font-bold rounded-lg w-10 h-10 flex items-center justify-center text-lg shadow-xl">B</div>
  ),
  Next: () => (
    <div className="bg-white text-black font-bold rounded-full w-10 h-10 flex items-center justify-center text-xl border border-slate-200 shadow-xl">N</div>
  )
};

const orbitItems = [
  { icon: <TechIcons.React />, angle: 0 },
  { icon: <TechIcons.NodeJS />, angle: 19 },
  { icon: <TechIcons.Express />, angle: 38 },
  { icon: <TechIcons.Prisma />, angle: 57 },
  { icon: <TechIcons.SocketIO />, angle: 76 },
  { icon: <TechIcons.Redis />, angle: 95 },
  { icon: <TechIcons.AWS />, angle: 114 },
  { icon: <TechIcons.Docker />, angle: 133 },
  { icon: <TechIcons.MongoDB />, angle: 152 },
  { icon: <TechIcons.Postgres />, angle: 171 },
  { icon: <TechIcons.TS />, angle: 190 },
  { icon: <TechIcons.Kubernetes />, angle: 209 },
  { icon: <TechIcons.Firebase />, angle: 228 },
  { icon: <TechIcons.JS />, angle: 247 },
  { icon: <TechIcons.DotNet />, angle: 266 },
  { icon: <TechIcons.Angular />, angle: 285 },
  { icon: <TechIcons.Tailwind />, angle: 304 },
  { icon: <TechIcons.Bootstrap />, angle: 323 },
  { icon: <TechIcons.Next />, angle: 342 },
];
      ...
      <div className="max-w-7xl mx-auto px-6 w-full grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative flex items-center justify-center animate-in fade-in zoom-in duration-1000">
          <div className="relative w-[500px] h-[500px] flex items-center justify-center group">
            ...
            {/* Conteneur d'icônes avec animation orbitale lente */}
            <div className="absolute inset-0 animate-orbit group-hover:[animation-play-state:paused]">
              {orbitItems.map((item, index) => {
                ...
                return (
                  ...
                  >
                    {/* Contre-rotation pour garder l'icône droite et lisible */}
                    <div className="animate-counter-orbit group-hover:[animation-play-state:paused]">
                      <div className="transition-transform duration-300 hover:scale-150 cursor-pointer flex items-center justify-center">
                        {item.icon}
                      </div>
                    </div>
                  </div>
